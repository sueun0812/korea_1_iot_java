package chapter20.Livrary2.service;

import chapter20.Livrary2.model.Book;
import chapter20.Livrary2.model.User;
import chapter20.Livrary2.repository.BookRepository;
import chapter20.Livrary2.repository.UserRepository;
...
public class LibraryService {
	...
	public void borrowBook(String userId, String bookTitle) {
		...
		if ( user != null && book != null && !book.isBorrowed()) {
			...
			// 책을 대여할 수 없는 상태
			System.out.println("대여 불가 : 사용자가 존재하지 않거나 도서가 이미 대여 중 입니다.");
		}		
	}
