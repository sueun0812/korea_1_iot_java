...
class Book2 {
	...
	Book2(String title, String publisher, int pageNumber) {	// 매개변수로 받은 데이터로 속성 초기화 
		this.title = title;
...
public class Object04 {
	...
	public static void main(String[] args) {
		...
		myBook2.displayInfo();	// 백설공주코리아it아카데미
		anotherBook.displayInfo();	//신데렐라에이원플라자
		
		// 속성 변경 방법
		myBook2.pageNumber = 1234;
		System.out.println(myBook2.pageNumber);	// 1234
